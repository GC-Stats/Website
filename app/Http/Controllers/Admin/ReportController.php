...
class ReportController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $reports = UserReport::with(['reporter:id,name,username', 'reportedUser:id,name,username', 'reportedMessage.user:id,name,username', 'team:id,name', 'emote', 'reactable'])
    ...
    public function show(UserReport $userReport): View
    {
        $userReport->load([
            ...
            'reportedUser.socialAccounts',
            'reportedUser.sanctions',
            'reportedMessage.user.socialAccounts',
            'reportedMessage.user.sanctions',
            'reportedMessage.thread',
            'team:id,name',
