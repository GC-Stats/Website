...
class AdminPermissions extends PermissionCatalog
{
    ...
    public static function grouped(): array
    {
        return [
            ...
            'staff' => ['staff.view', 'staff.create', 'staff.edit', 'staff.delete', 'staff.merge', 'staff.assignments.manage'],
            'news' => ['news.view', 'news.create', 'news.edit', 'news.delete', 'news.publish', 'news.validate', 'news.publish.unvalidated'],
            ...
            'users' => ['users.view', 'users.view.details'],
