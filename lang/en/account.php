...
return [
    ...
    'errors' => [
        ...
        'social_login_expired' => 'Your login session expired or was invalid — please try signing in again.',
        'social_login_failed' => 'Something went wrong while signing you in with :provider — please try again.',
        'not_own_social_account' => "This isn't one of your linked accounts.",
        'not_own_notification' => "This isn't one of your notifications.",
        'not_own_report' => "This isn't one of your reports.",
        'not_eligible_for_bio' => "You're not eligible to set a bio yet — this usually requires an older account or a verified linked social account.",
        'not_own_change_request' => "This isn't one of your change requests.",
