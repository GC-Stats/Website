...
return [
    ...
    'errors' => [
        ...
        'social_login_expired' => 'Ta session de connexion a expiré ou est invalide — merci de réessayer.',
        'social_login_failed' => 'Une erreur est survenue lors de la connexion avec :provider — merci de réessayer.',
        'not_own_social_account' => "Ce n'est pas un de tes comptes liés.",
        'not_own_notification' => "Ce n'est pas une de tes notifications.",
        'not_own_report' => "Ce n'est pas un de tes signalements.",
        'not_eligible_for_bio' => "Tu n'es pas encore éligible pour définir une bio — cela nécessite en général un compte plus ancien ou un réseau social lié vérifié.",
        'not_own_change_request' => "Ce n'est pas une de tes demandes de modification.",
