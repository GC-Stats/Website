...
@section('content')
    ...
    <div class="bg-bg-card border border-border-subtle rounded-sm shadow-xl p-4 mb-6">
    ...
    <div class="bg-bg-card border border-border-subtle rounded-sm shadow-xl overflow-x-auto">
        <div class="px-4 py-3 border-b border-b-border-subtle">
        ...
        <table class="w-full text-sm text-left">
            <thead>
                <tr class="border-b border-b-border-subtle text-[10px] font-black uppercase tracking-widest text-gray-500">
                    ...
                    <th class="px-4 py-3">{{ __('admin.analytics.views') }}</th>
                </tr>
            </thead>
            <tbody>
                @forelse ($topPages as $page)
                    <tr class="border-b border-b-border-subtle last:border-b-0">
