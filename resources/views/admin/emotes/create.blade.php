...
@section('title', __('admin.emotes.create.title'))
...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-black uppercase tracking-tighter text-white">{{ __('admin.emotes.create.title') }}</h1>
    </div>

    <form method="POST" action="{{ route('admin.emotes.store') }}" enctype="multipart/form-data">
        @csrf

        @include('admin.emotes._form', ['emote' => null, 'teams' => $teams, 'sources' => $sources])
