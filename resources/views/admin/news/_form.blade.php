...
<div>
    ...
    <textarea name="excerpt" rows="2"
              class="w-full bg-[#050505] border border-border-subtle rounded-sm px-4 py-3 text-sm text-white focus:outline-none focus:border-gc-yellow transition">{{ old('excerpt', $article?->excerpt) }}</textarea>
</div>
...
<div>
    ...
    <textarea name="content" rows="14" required
              class="w-full bg-[#050505] border border-border-subtle rounded-sm px-4 py-3 text-sm text-white focus:outline-none focus:border-gc-yellow transition">{{ old('content', $article?->content) }}</textarea>
</div>
