                ...
                <form method="POST" action="{{ route('admin.news.authors.update', $author) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="bio" rows="4"
                                  class="w-full bg-[#050505] border border-border-subtle rounded-sm px-4 py-3 text-sm text-white focus:outline-none focus:border-gc-yellow transition">{{ $author->bio }}</textarea>
                    </div>
