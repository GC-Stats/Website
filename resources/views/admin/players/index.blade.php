    ...
    <div class="flex items-center justify-between mb-6 gap-4 flex-wrap">
        <form method="GET" action="{{ route('admin.players.index') }}" class="flex flex-wrap gap-2 flex-1 min-w-[200px]">
            ...
            <x-styled-select name="sort" :selected="$sort" autosubmit class="w-44"
                :options="[
                    'name' => __('admin.players.sort.name'),
                    'country' => __('admin.players.sort.country'),
                    'recent_activity' => __('admin.players.sort.recent_activity'),
                ]" />

            <x-styled-select name="active_within" :selected="$activeWithin" autosubmit class="w-40"
                :options="[
                    '' => __('admin.players.active_within.any'),
                    '30d' => __('admin.players.active_within.30d'),
                    '90d' => __('admin.players.active_within.90d'),
                    '6m' => __('admin.players.active_within.6m'),
                    '1y' => __('admin.players.active_within.1y'),
                ]" />
