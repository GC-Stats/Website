{{--
    GC-Stats — Round-robin standings/results component

    Computes and renders the standings table and match results grid for a
    round-robin tournament phase.
...
<div class="border border-border-subtle rounded-sm w-full bg-bg-card overflow-hidden">
    ...
    <x-public.tournament.qualification-legend :qualifications="$advancementRules" />
</div>
