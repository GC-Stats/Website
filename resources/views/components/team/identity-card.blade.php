{{--
    GC-Stats — Team identity card

    The logo/name/country/bio/socials block — extracted from
    public/team/header.blade.php so the exact same visual can be reused
    ...
    $team is the same array shape every team page passes ($team->toArray()).
